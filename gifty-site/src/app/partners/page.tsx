      ...
      <div className="grid gap-10 md:grid-cols-2 md:items-start">
        <div>
          ...
          <p className="mt-4 text-sm text-zinc-600">
            Если вы магазин, студия, флористика или корпоративные подарки — мы
            поможем собрать ассортимент и оптовую сетку. На MVP отправка формы
            отключена: мы просто показываем сценарий.
          </p>
          ...
          <div className="mt-8 grid gap-3">
            <div className="rounded-2xl border border-zinc-200 bg-white p-6 shadow-sm">
              ...
              <p className="mt-2 text-sm text-zinc-600">
                Здесь будут логотипы (пока — заглушка).
              </p>
        ...
        <div className="rounded-3xl border border-zinc-200 bg-white p-8 shadow-sm">
          <h2 className="text-xl font-semibold tracking-tight">
            Заявка партнёра / опта
          </h2>
          <p className="mt-2 text-sm text-zinc-600">
            MVP: отправка будет подключена (email/CRM/Telegram бот).
          </p>
