      ...
      <section className="subtle-grid border-b border-zinc-200/70">
        <div className="container py-14 md:py-20">
          <div className="max-w-3xl">
            <Badge className="border-zinc-300 bg-white">Brand + Shop + Wholesale</Badge>
            <h1 className="mt-6 text-4xl font-semibold leading-tight tracking-tight md:text-6xl">
              Подарочная упаковка с{" "}
              <span className="underline decoration-zinc-900/20 underline-offset-8">
                редакционной
              </span>{" "}
              эстетикой
            </h1>
            <p className="mt-5 text-base text-zinc-600 md:text-lg">
              GIFTY — витрина бренда + чистый e‑commerce + оптовый кабинет для
              закупки пакетов, бумаги и открыток.
            </p>
          ...
          <div className="mt-12 grid gap-4 md:grid-cols-3">
            ...
            <div className="rounded-2xl border border-zinc-200 bg-white p-6 shadow-sm">
              ...
              <p className="mt-2 text-sm text-zinc-600">
                Пишем про упаковку, материалы и подбор размеров.
              </p>
              <Link
                href="/blog"
                className="mt-4 inline-block text-sm font-medium text-zinc-900 underline decoration-zinc-900/20 underline-offset-4"
          ...
          <div className="grid gap-10 md:grid-cols-2 md:items-center">
            <div>
              <h3 className="text-2xl font-semibold tracking-tight">
                Для оптовиков и партнёров
              </h3>
              <p className="mt-3 text-sm text-zinc-600">
                Кабинет с оптовыми ценами, MOQ и кратностью. Быстрый заказ — как
                в сильных B2B‑каталогах.
              </p>
            ...
            <div className="grid gap-3">
              <div className="rounded-2xl border border-zinc-200 bg-zinc-50 p-5">
                <div className="text-sm font-semibold">MOQ + кратность</div>
                <p className="mt-1 text-sm text-zinc-600">
                  Подсказки в таблице быстрых заказов — без блокировок на MVP.
                </p>
              </div>
              <div className="rounded-2xl border border-zinc-200 bg-zinc-50 p-5">
                <div className="text-sm font-semibold">Заказы и документы</div>
                <p className="mt-1 text-sm text-zinc-600">
                  Страница‑заглушка под счета/акты/PDF — уже в роутинге.
                </p>
              </div>
              <div className="rounded-2xl border border-zinc-200 bg-zinc-50 p-5">
                <div className="text-sm font-semibold">Repeat order</div>
                <p className="mt-1 text-sm text-zinc-600">
                  В MVP — как заглушка, но маршрут предусмотрен.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="container pb-16">
        <div className="flex items-end justify-between gap-6">
          <div>
            ...
            <p className="mt-2 text-sm text-zinc-600">
              Новости бренда и заметки о подборе упаковки.
            </p>
          </div>
          <Link
            href="/blog"
