      ...
      <div className="container grid gap-10 py-12 md:grid-cols-3">
        <div>
          ...
          <p className="mt-2 max-w-sm text-sm text-zinc-600">
            Editorial‑витрина бренда + чистый e‑commerce + оптовый кабинет для
            закупщиков.
          </p>
          <p className="mt-4 text-xs text-zinc-500">
            © {new Date().getFullYear()} GIFTY. MVP.
          </p>
        </div>
        ...
        <div>
          ...
          <p className="mt-4 text-xs text-zinc-500">
            Формы на сайте сейчас в режиме MVP: отправка будет подключена
            отдельно.
          </p>
        </div>
      </div>
